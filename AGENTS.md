...
3. `../venture-os/ventures/bidscreen/` — `config.json`, `context.md`, `voice-guide.md`,
   `visual-standards.md`, `learnings.md` (whichever exist)
4. The relevant cluster research file in `../venture-os/ventures/bidscreen/`
...
- British English (UK); AI framing must say "AI screening", never a GO/CAUTION/NO-GO verdict
